...
public class EstudianteResource {
     ...
     * Valid realiza la comprobación de los datos según las especificacion del objeto EstudianteRequestDTO
     * Si la validación falla, se lanza una exception que captura la clase GlobalExceptionHandler, quien retorna la respuesta con el error de validación
     ...
     * Permite recuperar la lista de estudiantes ordenados por un campo, paginados (opcional) y con limite de registro(opcional)
     ...
     * @param estudianteDTO Permite especificar metodos de ordenamiento, paginado y limite de registros para la consulta
